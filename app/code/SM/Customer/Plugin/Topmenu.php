...
class   Topmenu
{
    ...
    {
        $menuNode = $this->nodeFactory->create(['data' => $this->getNodeAsArray("List Customer", "list-customer"),
            'idField' => 'id',
...
//            'tree' => $subject->getMenu()->getTree(),]));
    ...
    {
        $url = $this->urlBuilder->getUrl("/").'customer/index/index'; //here you can add url as per your choice of menu
        return [
            'name' => __($name),
            'id' => $id,
            'url' => $url,
